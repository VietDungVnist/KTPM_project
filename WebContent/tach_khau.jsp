...
<body>
	...
	<div class="tao_tai_khoan">
		<div id="taotaikhoan">Đăng ký tách khẩu</div>
		<form method="POST" action="TachKhauServlet">
			<fieldset class="taotk_field">
				<label style="display: block">Địa chỉ thường trú mới</label>
				<input name="diachi" type="text" maxlength="255" value="" required>
			</fieldset>
